...
parser.add_argument('--processed-data', type=str, required=True, help='path to save the processed data')
...
ben_data = ben_data.sample(200000)

mal_data = data[data.label == 1]
mal_data = mal_data.drop('type', axis=1)
mal_data = mal_data.sample(10000)
