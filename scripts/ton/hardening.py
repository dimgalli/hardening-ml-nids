...
parser.add_argument('--generated-data', type=str, required=True, help='path to generated data')
parser.add_argument('--baseline-normal-scores', type=str, required=True, help='path to save the baseline detector scores in normal settings')
parser.add_argument('--baseline-adversarial-scores', type=str, required=True, help='path to save the baseline detector scores in adversarial settings')
parser.add_argument('--hardened-normal-scores', type=str, required=True, help='path to save the hardened detector scores in normal settings')
parser.add_argument('--hardened-adversarial-scores', type=str, required=True, help='path to save the hardened detector scores in adversarial settings')
